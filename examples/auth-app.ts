...
console.log(`   GET  http://localhost:${port}/api/users/me - 获取当前用户（需要 Bearer token）`);
console.log(`   GET  http://localhost:${port}/api/users/ - 获取所有用户（需要管理员权限）`);
console.log(`\n🔑 OAuth2 端点:`);
console.log(`   GET  http://localhost:${port}/oauth2/authorize - 授权端点`);
console.log(`   POST http://localhost:${port}/oauth2/token - 令牌端点`);
console.log(`   GET  http://localhost:${port}/oauth2/userinfo - 用户信息端点`);
console.log(`\n💡 测试账号:`);
